...
use Fabricate\Console\Concerns\FindsAvailableModels;
use Fabricate\Contracts\Console\PromptsForMissingInput;
...
abstract class GeneratorCommand extends Command implements PromptsForMissingInput
{
    ...
    protected function getPath($name)
    {
        ...
        return $this->scrapyard_io['path'].'/'.str_replace('\\', '/', $name).'.php';
    }
    ...
    {
        return $this->scrapyard_io->getNamespace();
    }
    ...
    {
        $config = $this->scrapyard_io['config'];
    ...
    {
        $views = $this->scrapyard_io['config']['view.paths'][0] ?? resource_path('views');
